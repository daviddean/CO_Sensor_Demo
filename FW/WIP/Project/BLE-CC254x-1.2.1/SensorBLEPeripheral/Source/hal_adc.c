...
uint16 HalAdcRead (uint8 channel, uint8 resolution)
{
  ...
  /* The following would disable channel after done conversion */
  // JHP - HOWEVER, we find that this lets the 2541 drive the
  // pin a bit, which we don't find desirable for our application
