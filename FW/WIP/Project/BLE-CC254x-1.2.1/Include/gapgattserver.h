...
#define GAP_DEVICE_NAME_LEN                     (31+1)
 ...
 * TYPEDEFS
 */
// Callback to notify when Device Name is changed over the air.
typedef void (*ggsDeviceNameChange_t)( void );

// GAP GATT Server callback structure
typedef struct
{
  ggsDeviceNameChange_t  pfnDeviceNameChange;  // When Device Name is changed OTA
} ggsAppCBs_t;
